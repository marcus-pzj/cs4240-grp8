...
public class RefractionToggleManager : MonoBehaviour
{
	...
	private RefractionLevelStateManager stateManager;
	...
	void Update()
	{
		...
		else
		{
			...
			stateManager = lasers[0].GetComponent<RefractionLevelStateManager>();
