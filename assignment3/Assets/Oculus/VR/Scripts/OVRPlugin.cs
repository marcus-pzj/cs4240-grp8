...
public static class OVRPlugin
{
...
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
	public static readonly System.Version wrapperVersion = _versionZero; // Disable for Mac
	// public static readonly System.Version wrapperVersion = new System.Version(0, 0, 0); // Enable for Mac
#else
	...
	public static bool initialized
	{
		get {
#if OVRPLUGIN_UNSUPPORTED_PLATFORM
			// return true;  // Enable for Mac
			return false; // Disable for Mac
#else
